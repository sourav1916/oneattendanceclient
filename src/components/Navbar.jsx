...
export default function Navbar({ 
  ...
  return (
    <motion.nav 
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="bg-white/90 backdrop-blur-xl border-b border-slate-200 shadow-sm w-full h-16 flex-shrink-0 relative z-50"
    >
      <div className="px-3 md:px-4 h-full flex items-center justify-between">
        ...
        <div className="flex items-center flex-1 min-w-0">
          ...
          >
            ...
            <span className="text-slate-800 font-semibold text-base whitespace-nowrap hidden sm:inline">
              OneAttendance
            </span>
          </motion.div>
        </div>
        ...
        <div className="flex items-center space-x-2 md:space-x-3">
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-xs rounded-full flex items-center justify-center text-white font-medium">
              3
            </span>
          </motion.button>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left min-w-0">
                <p className="text-slate-800 font-medium text-sm truncate max-w-32">{user?.name || 'John Doe'}</p>
                <p className="text-xs text-slate-500 capitalize truncate">{user?.role || 'Developer'}</p>
              </div>
              <motion.div
