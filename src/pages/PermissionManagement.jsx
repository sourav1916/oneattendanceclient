...
const Pagination = ({
  ...
  return (
    <motion.div
      ...
      className={`mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white px-4 py-4 rounded-2xl shadow-lg ${className}`}
    >
      ...
      <div className="flex gap-1 flex-wrap justify-center">
        <button
          ...
          className={`px-2 sm:px-4 py-2 rounded-xl border flex items-center gap-1 sm:gap-2 text-xs sm:text-sm transition-all duration-300 ${isFirstPage
            ...
            {getPageNumbers().map((page, index) =>
              page === '...' ? (
                ...
                <button key={page} onClick={() => onPageChange(page)}
                  className={`px-2 sm:px-4 py-2 rounded-xl transition-all duration-300 font-medium text-xs sm:text-sm ${currentPage === page
        ...
        <button
          ...
          disabled={isLastPage}
          className={`px-2 sm:px-4 py-2 rounded-xl border flex items-center gap-1 sm:gap-2 text-xs sm:text-sm transition-all duration-300 ${isLastPage
            ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
            : 'bg-white text-gray-700 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-600 hover:text-white hover:border-transparent'
            }`}
        >
