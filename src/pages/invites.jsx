                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 flex items-center gap-1">
                                        <FaEnvelope size={12} /> {invite.invited_by.email}
                                    </p>
            ...
            >
                ...
                <div className="p-6 text-center">
                    ...
                    <p className="text-gray-500 mb-6">
                        You are about to accept the invitation from{' '}
                        <span className="font-semibold text-green-600">{invite.company?.name}</span>.
            ...
            >
                ...
                <div className="p-6 text-center">
                    ...
                    <p className="text-gray-500 mb-6">
                        ...
                        <span className="font-semibold text-red-600">{invite.company?.name}</span>?
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 text-right relative">
                                                        <button
                                                            onClick={(e) => toggleActionMenu(e, invite.invite_id)}
                                                            ...
                                                            {activeActionMenu === invite.invite_id && (
                                                                ...
                                                                >
                                                                    <button
                                                                        ...
                                                                        className="w-full text-left px-4 py-3 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 text-purple-600 flex items-center gap-3 transition-all duration-300"
                                                                    >
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                                                    ...
                                                    {[invite.company?.city, invite.company?.state].filter(Boolean).join(', ') || 'Location not provided'}
                                                </p>
