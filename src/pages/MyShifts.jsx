...
const SummaryCard = ({ icon, label, value, color, delay = 0 }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-white rounded-xl shadow-md border border-gray-100 p-4 flex items-center gap-3 hover:shadow-lg transition-all duration-300"
        >
        ...
        >
            <div className="space-y-6">
                ...
                <motion.div
                    ...
                    className="mb-6"
                >
                    <div className="flex items-center justify-between bg-white rounded-xl shadow-md border border-gray-100 p-3 md:p-4">
                        <motion.button
                    ...
                    <AnimatePresence>
                        {monthPickerOpen && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                exit={{ opacity: 0, y: -10 }}
                                className="mt-2 bg-white border border-gray-200 rounded-xl shadow-xl p-3 grid grid-cols-4 gap-2"
                            >
                                {MONTHS.map((m, i) => {
                ...
                {!loading && shifts.length > 0 && viewMode === 'table' && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-xl shadow-xl overflow-visible mb-4"
                        >
                            ...
                            >
                                <div className="flex items-start justify-between gap-3 mb-4">
                                    <div className="flex items-start gap-3">
                                        <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-300">
