              ...
              <div className="space-y-3 pl-10 xsm:pl-0">
                {dateHolidays.map((holiday, idx) => (
                  <div
                    ...
                    className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:border-indigo-200 transition-all hover:bg-white hover:shadow-sm cursor-pointer active:scale-[0.98] group/item"
                  >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 xsm:p-2 sm:p-4 md:p-6 lg:p-8 font-outfit">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Calendar Controls */}
        <div className="bg-white rounded-xl xsm:rounded-xl shadow-sm border border-gray-200 p-3 xsm:p-2 mb-4 xsm:mb-3">
