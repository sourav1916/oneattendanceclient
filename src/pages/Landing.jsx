          ...
          >
            {featureCards.map((feature, index) => (
              ...
              >
                ...
                />
                <div className={`w-20 h-20 mx-auto ${feature.bgColor} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/signup')}
              className="px-10 py-4 bg-white text-blue-600 font-bold text-lg rounded-2xl shadow-2xl flex items-center justify-center gap-2 group"
            >
              Create Free Account
              <motion.div
                animate={{ x: [0, 5, 0] }}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/login')}
              className="px-10 py-4 font-semibold text-lg rounded-2xl border-2 border-white hover:bg-white/20 transition-all duration-200"
            >
              Login Now
            </motion.button>
          </motion.div>
